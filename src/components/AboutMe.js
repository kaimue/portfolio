  ...
  return (
    <div id="aboutMe">
      ...
      <p id="secondAbout">
        ...
        when the user is not signed in). Finally, you can simply inject
        whichever component one needs depending on its route rather than
        wrapping each route component in a parent layout component like:
      </p>
    </div>
  );
};
